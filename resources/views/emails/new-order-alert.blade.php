...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .order-info { background: #fef2f2; border: 1px solid #fca5a5; border-radius: 12px; padding: 20px; margin-bottom: 24px; }
        ...
        .total-row { display: flex; justify-content: space-between; padding: 12px 0 0; font-size: 16px; font-weight: 800; color: #dc2626; border-top: 2px solid #fca5a5; margin-top: 8px; }
    ...
    <div class="wrapper">
        <div class="card">
            <div class="header">
                ...
                <div class="header-sub">A customer just placed an order</div>
            </div>
