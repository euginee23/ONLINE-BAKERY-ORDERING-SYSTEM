    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <nav class="items-center hidden gap-1 md:flex">
                <a
                    ...
                    @class([
                        ...
                        'text-gold-700 bg-gold-50 dark:text-gold-400 dark:bg-gold-900/20' => request()->routeIs('customer.menu'),
                        'text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:text-white dark:hover:bg-zinc-800' => ! request()->routeIs('customer.menu'),
                    ])
                >
                    Browse Menu
                </a>
                <a
                    ...
                    @class([
                        'px-3 py-2 text-sm font-medium transition rounded-lg',
                        'text-gold-700 bg-gold-50 dark:text-gold-400 dark:bg-gold-900/20' => request()->routeIs('customer.orders*'),
                        'text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:text-white dark:hover:bg-zinc-800' => ! request()->routeIs('customer.orders*'),
                    ])
                >
                    My Orders
                </a>
                <a
                    ...
                    @class([
                        'px-3 py-2 text-sm font-medium transition rounded-lg',
                        'text-gold-700 bg-gold-50 dark:text-gold-400 dark:bg-gold-900/20' => request()->routeIs('dashboard'),
                        'text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:text-white dark:hover:bg-zinc-800' => ! request()->routeIs('dashboard'),
                    ])
                >
                    Dashboard
                </a>
            ...
            <div class="items-center hidden gap-3 md:flex">
                ...
                <a
                    ...
                    wire:navigate
                    class="relative flex items-center justify-center transition rounded-lg size-9 text-zinc-500 hover:text-zinc-900 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:text-white dark:hover:bg-zinc-800"
                    aria-label="Cart"
                >
                    ...
                    @endphp
                    @if($cartCount > 0)
                        <span class="absolute -top-1 -right-1 flex items-center justify-center rounded-full size-4 bg-gold-700 text-white text-[10px] font-bold dark:bg-gold-500 dark:text-zinc-900">
                ...
                <div class="relative" x-data="{ open: false }" x-on:click.away="open = false">
                    ...
                    >
                        <button x-on:click="$flux.appearance = 'light'; open = false" class="flex items-center w-full gap-3 px-4 py-2 text-sm transition cursor-pointer" :class="$flux.appearance === 'light' ? 'text-gold-700 dark:text-gold-400 bg-gold-50 dark:bg-gold-900/20' : 'text-zinc-700 dark:text-zinc-300 hover:text-gold-700 dark:hover:text-gold-400 hover:bg-gold-50 dark:hover:bg-zinc-800'">
                        ...
                        <button x-on:click="$flux.appearance = 'dark'; open = false" class="flex items-center w-full gap-3 px-4 py-2 text-sm transition cursor-pointer" :class="$flux.appearance === 'dark' ? 'text-gold-700 dark:text-gold-400 bg-gold-50 dark:bg-gold-900/20' : 'text-zinc-700 dark:text-zinc-300 hover:text-gold-700 dark:hover:text-gold-400 hover:bg-gold-50 dark:hover:bg-zinc-800'">
                        ...
                        <button x-on:click="$flux.appearance = 'system'; open = false" class="flex items-center w-full gap-3 px-4 py-2 text-sm transition cursor-pointer" :class="$flux.appearance === 'system' ? 'text-gold-700 dark:text-gold-400 bg-gold-50 dark:bg-gold-900/20' : 'text-zinc-700 dark:text-zinc-300 hover:text-gold-700 dark:hover:text-gold-400 hover:bg-gold-50 dark:hover:bg-zinc-800'">
                ...
                <div class="relative" x-data="{ userOpen: false }" x-on:click.away="userOpen = false">
                    ...
                    >
                        ...
                        <a href="{{ route('profile.edit') }}" wire:navigate class="flex items-center gap-2 px-4 py-2 text-sm text-zinc-700 hover:bg-zinc-50 dark:text-zinc-300 dark:hover:bg-zinc-800" x-on:click="userOpen = false">
                        ...
                        <form method="POST" action="{{ route('logout') }}" class="w-full">
                            @csrf
                            <button type="submit" class="flex items-center w-full gap-2 px-4 py-2 text-sm text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20">
        ...
        >
            <nav class="flex flex-col gap-1 pt-3">
                <a href="{{ route('dashboard') }}" wire:navigate x-on:click="mobileOpen = false" @class(['px-3 py-2 text-sm font-medium transition rounded-lg', 'text-gold-700 bg-gold-50 dark:text-gold-400 dark:bg-gold-900/20' => request()->routeIs('dashboard'), 'text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:text-white dark:hover:bg-zinc-800' => ! request()->routeIs('dashboard')])>Dashboard</a>
                <a href="{{ route('customer.menu') }}" wire:navigate x-on:click="mobileOpen = false" @class(['px-3 py-2 text-sm font-medium transition rounded-lg', 'text-gold-700 bg-gold-50 dark:text-gold-400 dark:bg-gold-900/20' => request()->routeIs('customer.menu'), 'text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:text-white dark:hover:bg-zinc-800' => ! request()->routeIs('customer.menu')])>Browse Menu</a>
                <a href="{{ route('customer.orders') }}" wire:navigate x-on:click="mobileOpen = false" @class(['px-3 py-2 text-sm font-medium transition rounded-lg', 'text-gold-700 bg-gold-50 dark:text-gold-400 dark:bg-gold-900/20' => request()->routeIs('customer.orders*'), 'text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:text-white dark:hover:bg-zinc-800' => ! request()->routeIs('customer.orders*')])>My Orders</a>
                <a href="{{ route('customer.checkout') }}" wire:navigate x-on:click="mobileOpen = false" class="flex items-center gap-2 px-3 py-2 text-sm font-medium transition rounded-lg text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:text-white dark:hover:bg-zinc-800">
                    Cart
                    @if(count(session()->get('cart', [])) > 0)
                        <span class="inline-flex items-center justify-center rounded-full size-4 bg-gold-700 text-white text-[10px] font-bold dark:bg-gold-500 dark:text-zinc-900">{{ count(session()->get('cart', [])) }}</span>
                    @endif
                </a>
            </nav>
